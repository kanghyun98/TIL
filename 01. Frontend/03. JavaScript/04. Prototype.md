...
어떤 생성자 함수(Constructor)를 `new` 연산자와 함께 호출하면 생성자 함수(Constructor)에서 정의된 내용을 바탕으로 새로운 instance가 생성된다.

이때 **instance에는 `__proto__` 라는 프로퍼티가 자동으로 부여**되는데, **이 프로퍼티는 생성자 함수(Constructor)의 `prototype`이라는 프로퍼티를 참조**한다.
...
<img src="https://user-images.githubusercontent.com/70627979/163802782-04e300bf-f616-4339-8d21-cf5fd718d481.png" alt="image" style="width: 70%;" />
